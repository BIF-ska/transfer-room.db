...
class Competition(Base):
    ...
    def __repr__(self):
        return f"Competition(Competition_id={self.Competition_id!r}, Competitionname={self.Competitionname!r}, divisionLevel={self.divisionLevel!r}, Country_id={self.Country_id!r})"